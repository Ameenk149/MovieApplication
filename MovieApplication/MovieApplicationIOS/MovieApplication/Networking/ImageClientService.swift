...
protocol ImageClientService {
    func downloadImage<Request: ApiRequest>(request: Request, completion: @escaping (UIImage?, Error?) -> Void)
...
final class ImageClient {
    ...
    private(set) var cachedTaskForImageView: [UIImageView : ApiService]
...
extension ImageClient: ImageClientService {
    func downloadImage<Request: ApiRequest>(request: Request, completion: @escaping (UIImage?, Error?) -> Void) {
        ...
        let service: ApiService = DefaultNetworkService()
